...
2. سجّل بإيميل وكلمة مرور — **ما في كود دعوة**. تدفّق أكواد الدعوة انشال من
   الواجهة، ومساره (`/api/signup`) انحذف مع جدول `invite_codes`.
3. بعد التسجيل بتنحوّل لصفحة الدفع؛ ولما يتفعّل الاشتراك بتوصل للمحاضرات
   والاختبار.
