...
/**
 * يستخرج YouTube video ID من رابط كامل، أو يرجّع النص نفسه لو كان أصلاً ID.
 * يدعم الأشكال:
...
/**
 * يستخرج معرف الفيديو المناسب حسب منصة الفيديو المختارة (يوتيوب أو Drive).
 */
export function extractVideoId(input, provider) {
  if (provider === "drive") return extractDriveFileId(input);
