...
export const TRADER_TYPES = {
  sniper: { label: "القناص", desc: "بتستنى نقطة الدخول المثالية بصبر، وبتدخل بدقة عالية." },
  scalper: { label: "المضارب السريع", desc: "بتفتح وبتسكر صفقات كتير بوقت قصير، وسرعة القرار أهم شي عندك." },
  day_trader: { label: "المتداول اليومي", desc: "بتفتح وبتسكر صفقاتك خلال نفس اليوم، ومرتاح بمتابعة الشارت لحظياً." },
  swing_trader: { label: "متداول السوينغ", desc: "بتحتفظ بصفقاتك لأيام أو أسابيع، وبتفكر على المدى الأبعد." },
};
