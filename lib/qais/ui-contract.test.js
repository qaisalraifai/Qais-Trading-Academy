...
/* ⚠️ المسارات انتقلت مع نقل الصفحات لمجموعة `(shell)` — والاختبار فشل صح
   وسمّى الملف الناقص. الشرط المسبق تحت هو اللي مسكها، وهاد سبب وجوده:
   حارس بيقرا صفر ملفات بينجح بلا معنى. */
const CONSUMERS = [
  "app/(shell)/dashboard/components/MarketIntelligenceView.js",
  "app/(shell)/dashboard/components/QaisEngineView.js",
];
