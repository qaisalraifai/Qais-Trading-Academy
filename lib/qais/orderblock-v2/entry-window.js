...
/* ============================================================================
   ...
   ⚠️ ما في رقم جديد. التصحيح **تماثل** مش معايرة.

   ✅ **مُشغَّل** — قراره (٢٠٢٦-٠٨-٢١): «شغل المرآة». فالافتراضي صار
   `"mirror"`، و`"global"` انترك للمقارنة وللاختبارات اللي بتوثّق الفرق.
   ============================================================================ */
export function impulseLegAt(majorSwings, asOfIndex, dirUp, options = {}) {
  const anchorMode = options.anchor ?? "mirror";
