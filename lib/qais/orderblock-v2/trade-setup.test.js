...
test("السلسلة الكاملة على الكتلة المتحقَّقة", () => {
  ...
  assert.equal(r.stop, r.chain.smt.point, "بالمضاعف الافتراضي (صفر) الستوب لازم يساوي نقطة الـSMT");
...
test("مصدر الستوب قابل للتبديل — والافتراضي `smt` ما تغيّر", () => {
  ...
  assert.equal(smt.stop, smt.chain.smt.point, "الافتراضي لازم يضل نقطة الـSMT");
