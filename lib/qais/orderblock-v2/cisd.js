...
export const CISD_DEFAULTS = {
  /* ⚠️ شرط الملاصقة — مش من نص القاعدة، انضاف بالتنفيذ.
     ...
     للسلسلة. الافتراضي `true` = السلوك القائم، لحد ما يقرر. */
  requireAdjacentRun: true,
 ...
 */
export function lastOppositeRun(candles, beforeIndex, dirUp, requireAdjacent = true) {
  /* ⚠️ `requireAdjacent` بيحدّد هل السلسلة لازم تكون **ملاصقة** للشمعة
     ...
     ⚠️ الافتراضي `true` — السلوك القائم ما تغيّر. */
