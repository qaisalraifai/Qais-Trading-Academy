...
/* حقل dukascopy = رمز الأداة عند Dukascopy (بحروف صغيرة، بدون فاصل) - مصدر
   بديل مجاني بالكامل وبدون حد عمق زمني عملي (لغاية سنة بداية تغطية الأداة
   نفسها)، مستخدم فقط بمسار أداة الريبلاي (lib/dukascopy-candles.js) لما
   يكون في anchor أقدم من مدى يوهو/Twelve Data. لو مو موجود، الأصل بيضل
   شغال عادي بس بدون تجاوز حد يوهو التاريخي لبعض الفريمات الصغيرة. */
export const ASSETS = [
  { group: "المعادن", items: [
    { v:"XAUUSD", label:"(ذهب) XAUUSD", yahoo:"GC=F", yahooSpot:"XAU=", twelveData:"XAU/USD", dukascopy:"xauusd", mult:100  },
    { v:"XAGUSD", label:"(فضة) XAGUSD", yahoo:"SI=F", yahooSpot:"XAG=", twelveData:"XAG/USD", dukascopy:"xagusd", mult:5000  },
    { v:"XPTUSD", label:"(بلاتين) XPTUSD", yahoo:"PL=F", yahooSpot:"XPT=", twelveData:"XPT/USD", dukascopy:"xptcmdusd", mult:100  },
    { v:"XPDUSD", label:"(بلاديوم) XPDUSD", yahoo:"PA=F", yahooSpot:"XPD=", twelveData:"XPD/USD", dukascopy:"xpdcmdusd", mult:100  },
