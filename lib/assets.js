...
export const ASSETS = [
  ...
  { group: "مؤشرات وأسهم", items: [
    ...
    /* ═══════════════════════════════════════════════════════════════════
       `compareDaily` — رمز **لوحة المقارنة على اليومي وحدها**.
       -------------------------------------------------------------------
       القرار فوق (عقد آجل بدل مؤشر نقدي) سببه **فجوات الجلسة**: المؤشر
       النقدي بيتحدث بس بجلسة نيويورك الرسمية فبتطلع قفزات وهمية. وهاي علّة
       حقيقية — **على الفريمات اللحظية**. على اليومي ما إلها أثر: الشمعة
       اليومية وحدة بأي حال.

       وبالمقابل العقد الآجل تاريخه اليومي **قصير**، وهاد مقيس على الإنتاج
       (٢٠٢٦-٠٨-٢٧): طلب تعميق على `ES=F` رجّع **٢٢٣ شمعة بس**، بينما
       `^GSPC` عنده عقود.

       فلوحة المقارنة على اليومي بتستعمل المؤشر النقدي، وكل شي تاني بيضل
       على العقد الآجل. الشارت الأساسي **ما بينمسّ إطلاقاً**.

       ⚠️ ولوحة المقارنة بتتخطّى Dukascopy على اليومي كمان (شوفي
       `loadCompare`)، لأنها بتعطي SPX500 ربع المدى وبترفض أي طلب تاني —
       مقيس بتلات جولات. */
    { v:"US30", label:"US30 (داو جونز)", yahoo:"YM=F", compareDaily:"^DJI", dukascopy:"usa30idxusd", mult:1  },
    { v:"NAS100", label:"NAS100 (ناسداك)", yahoo:"NQ=F", compareDaily:"^NDX", dukascopy:"usatechidxusd", mult:1  },
    { v:"SPX500", label:"SPX500 (S&P 500)", yahoo:"ES=F", compareDaily:"^GSPC", dukascopy:"usa500idxusd", mult:1  },
