...
/* ============================================================================
   ...
   تحديث إضافي: قبل ما نجرب حتى Yahoo، منجرب حقل twelveData (لو موجود)
   عند مزوّد Twelve Data - وهاد سبوت حقيقي 100% (رمز XAU/USD نفسه)، مش
   تخمين ولا عقد آجل، فبيطابق TradingView/البروكر بدقة أعلى بكثير من أي
   بديل عندنا. يحتاج متغير بيئة TWELVE_DATA_API_KEY (خطة مجانية: 800
   طلب/يوم). لو المتغير مش مضبوط أو الطلب فشل، بيرجع تلقائياً لسلسلة
   Yahoo القديمة فوق (سبوت ثم عقد آجل) بدون أي انقطاع. شوفي
   lib/twelvedata-candles.js وapp/api/replay-candles/route.js. */
export const ASSETS = [
  { group: "المعادن", items: [
    { v:"XAUUSD", label:"(ذهب) XAUUSD", yahoo:"GC=F", yahooSpot:"XAU=", twelveData:"XAU/USD", mult:100  },
    { v:"XAGUSD", label:"(فضة) XAGUSD", yahoo:"SI=F", yahooSpot:"XAG=", twelveData:"XAG/USD", mult:5000  },
    { v:"XPTUSD", label:"(بلاتين) XPTUSD", yahoo:"PL=F", yahooSpot:"XPT=", twelveData:"XPT/USD", mult:100  },
    { v:"XPDUSD", label:"(بلاديوم) XPDUSD", yahoo:"PA=F", yahooSpot:"XPD=", twelveData:"XPD/USD", mult:100  },
