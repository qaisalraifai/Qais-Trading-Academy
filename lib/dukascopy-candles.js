 ...
 */
/* ⚠️ `budgetMs` **ما عاد يُستعمل** — انترك بالتوقيع عشان ما ينكسر المُستدعي.
   كان يضبط فواصل الانتظار بين محاولات التقليص، والانتظار انشال من جوّا
   الطلب بعد ما طلّع 504 (شوف الشرح عند `SPAN_RETRIES`). الانتظار صار
   بالعميل حيث ما إله سقف.
...
export async function fetchDukascopyCandles(
  ...
  /* ══════════════════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════════════════ */
  /* ══════════════════════════════════════════════════════════════════════
     🔴 **الانتظار انشال من جوّا الطلب — كان بيطلّع 504.**
     ----------------------------------------------------------------------
     كنت أضيف فواصل بين محاولات التقليص عشان أتفادى حد الأرشيف. والفواصل
     صحيحة كفكرة (مقيس: ~٤٠٠ملّي بتفشل · ٦–١٥ ثانية بتمرّق) — بس **مكانها
     غلط**.

     الحساب: مهلة القص ٢٧ ثانية + تلات فواصل ٦ = ١٨ + الجلبات + قراءة
     المخزن… و`maxDuration` **٣٠**. يعني الطلب صار يقدر يتجاوز السقف
     بنيوياً، وVercel بترجّع **504** — وهاد بالضبط اللي ظهر بالإنتاج.

     الانتظار مكانه **العميل**: هناك بالخلفية، مجاني، بلا سقف، وبيتراجع
     تصاعدياً (٥ · ١٥ · ٤٥ · ٩٠ ثانية بـ`ReplayClient`). فالطلب صار سريعاً
     وحاسماً: بينجح أو بيفشل بسرعة، والعميل بيقرّر متى يعيد.

     ⚠️ وتقليص المدى بيضل شغّالاً — بس بلا نوم بينهن. هو رخيص وبيساعد لما
        يكون الرفض بسبب الحجم مش بسبب النافذة.
     ══════════════════════════════════════════════════════════════════════ */
