...
const ASSETS = [
  ...
  {
    group: "فوركس (يدوي فقط - لا يوجد مصدر حي مجاني)",
    items: [
      { v: "EURUSD", label: "EUR/USD", mult: 100000, source: null },
      { v: "GBPUSD", label: "GBP/USD", mult: 100000, source: null },
      { v: "USDJPY", label: "USD/JPY", mult: 1000, source: null },
      { v: "USDCHF", label: "USD/CHF", mult: 100000, source: null },
      { v: "AUDUSD", label: "AUD/USD", mult: 100000, source: null },
      { v: "USDCAD", label: "USD/CAD", mult: 100000, source: null },
      { v: "NZDUSD", label: "NZD/USD", mult: 100000, source: null },
      { v: "EURJPY", label: "EUR/JPY", mult: 1000, source: null },
      { v: "GBPJPY", label: "GBP/JPY", mult: 1000, source: null },
      { v: "EURGBP", label: "EUR/GBP", mult: 100000, source: null },
    ],
  },
  {
...
export default function BacktestClient({ userId, username, initialBalance, initialTrades }) {
  ...
  return (
    <div style={{ direction: "rtl" }}>
      <style>{`
        :root{
          --bg:#0a0a0a; --panel:linear-gradient(145deg, #111108, #0d0d0a); --panel2:#15151a;
          --border:#C9A24B22; --border-strong:#C9A24B55; --gold:#C9A24B; --gold-dark:#a07a2e;
          --green:#10b981; --red:#ef4444; --text:#ffffff; --muted:#666666;
        }
        .qta-root{ background:radial-gradient(ellipse at top, #1a1200 0%, #0a0a0a 60%); color:var(--text);
        ...
        .qta-header-logo{width:46px;height:46px;border-radius:50%;border:2px solid var(--gold);box-shadow:0 0 20px #C9A24B44;overflow:hidden;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:#000;font-size:1.1rem;}
        ...
        .qta-badge-user{background:#C9A24B14;color:var(--gold);border-color:var(--border);}
        .qta-badge-balance{background:#0f3d2c;color:var(--green);cursor:pointer;border-color:#10b98133;}
        ...
        .qta-mode-btn{background:#0d0d0a;border:1px solid var(--border);color:var(--muted);padding:0.4rem 0.9rem;border-radius:8px;cursor:pointer;font-size:0.8rem;transition:all .15s;}
        ...
        .qta-field input, .qta-field select{width:100%;background:#0d0d0a;border:1px solid var(--border);color:var(--text);padding:0.55rem 0.6rem;border-radius:8px;font-size:0.9rem;}
        .qta-field input:focus, .qta-field select:focus{outline:none;border-color:var(--gold);box-shadow:0 0 0 3px #C9A24B1a;}
        .qta-btn-add{background:linear-gradient(135deg, var(--gold), var(--gold-dark));color:#000;border:none;border-radius:8px;font-weight:bold;font-size:0.95rem;cursor:pointer;height:38px;margin-top:1.4rem;box-shadow:0 4px 12px #C9A24B44;width:100%;}
        .qta-btn-add:hover{filter:brightness(1.1);}
        .qta-btn-add.live{background:var(--green);box-shadow:0 4px 12px #10b98144;}
        ...
        .qta-table tbody tr:hover{background:#C9A24B0d;}
        ...
        .qta-modal-box{background:linear-gradient(145deg, #151007, #0d0d0a);border:1px solid var(--border-strong);border-radius:16px;padding:1.5rem;width:340px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,0.6);}
        .qta-modal-box h3{margin-top:0;color:var(--gold);}
        .qta-modal-box input{width:100%;background:#0d0d0a;border:1px solid var(--border);color:var(--text);padding:0.6rem;border-radius:8px;margin:0.5rem 0 1rem;font-size:0.95rem;}
