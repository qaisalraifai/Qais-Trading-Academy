...
export default function BacktestClient({ userId, username, initialBalance, initialTrades, onExit }) {
  ...
  return (
    <div style={{ direction: "rtl" }}>
      <style>{`
        :root{
          --bg:#0a0a0a; --panel:linear-gradient(145deg, #111108, #0A0A0A); --panel2:#15151a;
          --border:#D4AF3722; --border-strong:#D4AF3755; --gold:#D4AF37; --gold-dark:#9C7A22;
          --green:#10b981; --red:#ef4444; --text:#ffffff; --muted:#666666;
        }
        .qta-root{ background:radial-gradient(ellipse at top, #1a1608 0%, #0a0a0a 60%); color:var(--text);
        ...
        .qta-mode-btn{background:#0A0A0A;border:1px solid var(--border);color:var(--muted);padding:0.4rem 0.9rem;border-radius:8px;cursor:pointer;font-size:0.8rem;transition:all .15s;}
        ...
        .qta-field input, .qta-field select{width:100%;background:#0A0A0A;border:1px solid var(--border);color:var(--text);padding:0.55rem 0.6rem;border-radius:8px;font-size:0.9rem;}
        ...
        .qta-modal-box{background:linear-gradient(145deg, #151007, #0A0A0A);border:1px solid var(--border-strong);border-radius:16px;padding:1.5rem;width:340px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,0.6);}
        .qta-modal-box h3{margin-top:0;color:var(--gold);}
        .qta-modal-box input{width:100%;background:#0A0A0A;border:1px solid var(--border);color:var(--text);padding:0.6rem;border-radius:8px;margin:0.5rem 0 1rem;font-size:0.95rem;}
