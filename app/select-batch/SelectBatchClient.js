  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "3rem 1.2rem" }}>
      <div style={{ textAlign: "center", marginBottom: "2.2rem" }}>
        <h1 style={{ fontSize: 26, fontWeight: 800, margin: 0, color: "#EAECEF" }}>أهلًا فيكِ 👋</h1>
        <p style={{ color: "#999", fontSize: 15, marginTop: "0.6rem", lineHeight: 1.7 }}>
      ...
      {batches.length === 0 ? (
        <p style={{ color: "#666", textAlign: "center", fontSize: 15 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.9rem" }}>
          {batches.map((b) => (
            ...
            >
              <div>
                <p style={{ margin: 0, fontWeight: 800, fontSize: 17, color: "#EAECEF" }}>{b.name}</p>
                <p style={{ margin: "0.4rem 0 0", color: "#888", fontSize: 13 }}>
              ...
              <button
                ...
                style={{
                  background: b.is_full ? "#333" : GOLD,
                  color: b.is_full ? "#888" : "#000",
                  border: "none",
                  borderRadius: 10,
