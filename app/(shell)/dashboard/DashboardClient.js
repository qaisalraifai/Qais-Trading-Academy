...
export default function DashboardClient({
  ...
  /* ⚠️ الغلاف انتقل لـ`app/(shell)/layout.js` — الداشبورد كان الوحيد اللي
     يرسم `AppShell` بنفسه بدل `PageShell`، والفرق الفعلي الوحيد كان
     `padded`. (`balance` و`showProfileHeader` كانوا بلا أثر: البلانص
     بينستعمل جوّا كرت البروفايل بس، والكرت كان مطفي هون أصلاً.)
     فبنعوّض الحشو بغلاف داخلي — نفس المظهر بالضبط، بلا غلاف مكرَّر. */
  return (
