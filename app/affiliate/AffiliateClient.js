...
const s = {
  page: { minHeight: "100vh", background: BG, direction: "rtl", fontFamily: "'Inter', sans-serif", color: "#F5F5F5", padding: "3rem 1.5rem", maxWidth: 900, margin: "0 auto" },
  ...
  sub: { color: "#6E6E6E", fontSize: "0.9rem" },
  ...
  cardTextSmall: { color: "#6E6E6E", fontSize: "0.82rem", lineHeight: 1.7, marginBottom: "1rem" },
  ...
  statusBadgeRejected: { color: "#FF4D4F", fontWeight: 700, fontSize: "0.95rem", marginBottom: 8 },
  ...
  statLabel: { color: "#6E6E6E", fontSize: "0.75rem", marginBottom: 6 },
  ...
  select: { background: "#080808", border: `1px solid ${BORDER}`, color: "#F5F5F5", padding: "0.7rem 1rem", borderRadius: 6, fontSize: "0.85rem" },
  input: { flex: 1, minWidth: 200, background: "#080808", border: `1px solid ${BORDER}`, color: "#F5F5F5", padding: "0.7rem 1rem", borderRadius: 6, fontSize: "0.85rem", direction: "ltr", textAlign: "right" },
  savedNote: { color: "#6E6E6E", fontSize: "0.78rem", marginTop: "0.8rem" },
