...
const CARD = "#0A0614";
const BORDER = "#241C3E";
const SLICE_COLORS = ["#DCD4F7", "#3D2F63", "#DCD4F7", "#2A2145", "#DCD4F7", "#3D2F63", "#2A2145"];
...
const s = {
  ...
  desc: { color: "#A79FC4", fontSize: "0.82rem", lineHeight: 1.6, marginBottom: "1.2rem" },
  error: { color: "#FF453A", fontSize: "0.8rem", marginBottom: "1rem" },
  wheelWrap: { position: "relative", width: 240, height: 240, margin: "0 auto 1.4rem" },
  pointer: { position: "absolute", top: -6, left: "50%", transform: "translateX(-50%)", width: 0, height: 0, borderLeft: "10px solid transparent", borderRight: "10px solid transparent", borderTop: "18px solid #F5F3FF", zIndex: 5 },
  ...
  sliceLabel: { position: "absolute", top: "20%", left: "-30%", fontSize: "0.6rem", color: "#0E0A1A", fontWeight: 700, whiteSpace: "nowrap" },
  btn: { background: GOLD, color: "#0E0A1A", border: "none", padding: "0.8rem 1.8rem", borderRadius: 3, fontWeight: 700, fontSize: "0.9rem", cursor: "pointer" },
  resultBox: { marginTop: "1.2rem", background: "#141024", border: `1px solid #3D2F63`, color: GOLD, padding: "0.8rem 1rem", borderRadius: 3, fontSize: "0.88rem" },
};
