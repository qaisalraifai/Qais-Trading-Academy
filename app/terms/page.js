...
const sectionsAr = [
  ...
  },
  {
    heading: "7. التواصل",
    body: [
      "لأي استفسار متعلق بهذه الشروط، يمكنكم التواصل معنا عبر قنوات الدعم المتاحة على المنصة أو عبر Discord.",
    ],
  },
];
...
const sectionsEn = [
  ...
  },
  {
    heading: "7. Contact",
    body: [
      "For any questions regarding these Terms, please reach out via the support channels available on the Platform or through Discord.",
    ],
  },
];
