  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: "0.5rem" }}>
        <span style={{ fontFamily: displayStack, fontSize: "2rem", fontWeight: 800, color: "#FFFFFF", letterSpacing: "-0.01em" }}>
          {prefix}
      ...
      {(sub || sparkline) && (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.5rem" }}>
          <span style={{ color: "#4A4368", fontSize: "0.78rem" }}>{sub}</span>
