...
const s = {
  page: { minHeight: "100vh", background: "#050505", direction: "rtl", fontFamily: "'Inter', sans-serif", color: "#E8E0D0", padding: "2.5rem 1.5rem", maxWidth: 1000, margin: "0 auto" },
  ...
  input: { background: "#080808", border: "1px solid #1a1a1a", color: "#E8E0D0", padding: "0.7rem 0.9rem", borderRadius: 6, fontSize: "0.85rem" },
  ...
  cardType: { color: "#6B6560", fontSize: "0.75rem", marginBottom: 10 },
