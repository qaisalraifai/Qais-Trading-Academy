    ...
    <div style={s.page}>
      ...
      {loading ? (
        ...
        <div style={s.grid}>
          ...
          {assets.length === 0 && <p style={{ color: "#4A4368" }}>ما في ملفات لسا.</p>}
        </div>
      )}
    </div>
  );
...
const s = {
  page: { minHeight: "100vh", background: "#0A0614", direction: "rtl", fontFamily: "'Inter', sans-serif", color: "#F5F3FF", padding: "2.5rem 1.5rem", maxWidth: 1000, margin: "0 auto" },
  title: { fontSize: "1.6rem", fontWeight: 800, marginBottom: 6, color: gold },
  sub: { color: "#6E6690", fontSize: "0.88rem", marginBottom: "1.8rem", lineHeight: 1.7 },
  error: { background: "#141024", border: "1px solid #FF453A44", color: "#FF453A", padding: "0.7rem 1rem", borderRadius: 3, marginBottom: "1rem", fontSize: "0.85rem" },
  form: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.7rem", background: "#0A0614", border: "1px solid #241C3E", borderRadius: 0, padding: "1.2rem", marginBottom: "2rem" },
  input: { background: "#0A0614", border: "1px solid #241C3E", color: "#F5F3FF", padding: "0.7rem 0.9rem", borderRadius: 3, fontSize: "0.85rem" },
  btn: { background: gold, color: "#0E0A1A", border: "none", padding: "0.7rem 1.2rem", borderRadius: 3, fontWeight: 700, fontSize: "0.85rem", cursor: "pointer", gridColumn: "1 / -1" },
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "1rem" },
  card: { background: "#0A0614", border: "1px solid #241C3E", borderRadius: 3, padding: "1.1rem" },
  cardTitle: { fontWeight: 700, fontSize: "0.9rem", marginBottom: 4 },
  cardType: { color: "#6E6690", fontSize: "0.75rem", marginBottom: 10 },
  link: { color: gold, fontSize: "0.8rem", textDecoration: "none", display: "block", marginBottom: 10 },
  deleteBtn: { background: "transparent", border: "1px solid #FF453A55", color: "#FF453A", padding: "0.4rem 0.8rem", borderRadius: 3, fontSize: "0.75rem", cursor: "pointer" },
};
