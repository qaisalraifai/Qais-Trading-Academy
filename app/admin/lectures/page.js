    ...
    <div style={s.page}>
      ...
      <header style={s.header}>
        ...
        <div style={{ display: "flex", gap: "0.75rem" }}>
          <Link href="/accounts" style={s.backBtn}>← رجوع للمشتركين</Link>
...
const s = {
  ...
  addCourseBtn: { backgroundColor: "#0D0E10", color: gold, border: `1px solid ${gold}55`, padding: "0 0.9rem", borderRadius: "4px", cursor: "pointer", fontSize: "0.8rem", fontWeight: 600, whiteSpace: "nowrap" },
  tableWrap: { margin: "2rem 3rem", border: "1px solid #111", borderRadius: "4px", overflow: "hidden" },
  table: { width: "100%", borderCollapse: "collapse" },
  th: { backgroundColor: "#0D0E10", padding: "1rem 1.25rem", textAlign: "right", fontSize: "0.78rem", color: "#444", fontWeight: 500, borderBottom: "1px solid #111" },
  ...
  btnDanger: { backgroundColor: "#2a1a1a", color: "#E5484D", border: "1px solid #4a2a2a", padding: "0.4rem 0.9rem", borderRadius: "4px", cursor: "pointer", fontSize: "0.82rem" },
