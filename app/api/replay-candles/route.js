...
/* ⚠️ **٢٠ ثانية مش ٢٧ — لازم يضل متّسع تحت `maxDuration`.**
   الرقم كان ٢٧ لما كانت Dukascopy تفشل بسرعة (٤ ثواني تقريباً) فما بتلمسه.
   بعد ما صارت **تنجح** بالعامل ١ (٢٣ سنة أرشيف)، صار الطلب يستهلك المهلة
   كاملة — وما بيضل وقت للتحويل والرد ولا للتراجع لمزوّد تاني، فالمنصّة
   بتقطع الدالة و`500` بترجع بلا أي جسم JSON.
   مقيس على الإنتاج: خمس ٥٠٠ متتالية بعد ما نجح العمق الكامل.
   بـ٢٠: تلات محاولات بتهدئة ٦ث بتخلص عند ~١٦.٨ث، وبيضل ~١٣ث للباقي. */
const DUKASCOPY_TIMEOUT_MS_ANCHOR = 20000;
