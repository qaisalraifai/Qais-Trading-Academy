...
const styles = {
  ...
  updated: { color: "#6E6690", fontSize: "0.85rem" },
  content: {
    width: "100%",
    maxWidth: "720px",
  ...
  contactLabel: { color: "#6E6690", fontSize: "0.85rem", margin: "0 0 0.4rem" },
  ...
  footerLink: { color: "#6E6690", fontSize: "0.85rem", textDecoration: "none" },
  dot: { color: "#2A2145" },
};
